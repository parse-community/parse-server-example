# parse-server-example + parse-dashboard

Example project using the [parse-server](https://github.com/ParsePlatform/parse-server) and [parse-dashboard](https://github.com/ParsePlatform/parse-dashboard) module on Express.
...
Access app at (http://localhost:1337/dashboard).
